...
public class Activity_embedded_navigation extends AppCompatActivity implements OnNavigationReadyCallback,
...
// Intentionally empty
    ...
    private String obtainOfflineTileVersion() {
        return PreferenceManager.getDefaultSharedPreferences(this)
                .getString(getString(R.string.mapbox_access_token), "");
    }
